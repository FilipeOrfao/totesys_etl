# from get_secrets_load import get_secret_db
...
def connect_to_load_db_cloud(secretsmanager_client=secretsmanager_client):
    try:
        db_info = get_secret_db(
            "project_team_6", secretsmanager_client=secretsmanager_client
        )
